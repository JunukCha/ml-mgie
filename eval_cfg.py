...
from CustomDataset import CustomDataset_cfg
...
def main():
    ...
    image_guidance_scales = [1.0, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2]
    guidance_scale = 7.5
    
    dataset = CustomDataset_cfg()
    ...
    for i, data in tqdm(enumerate(dataloader), total=len(dataloader)):
        ...
        with T.inference_mode():
            ...
            res = pipe(
                ...
                image_guidance_scale=image_guidance_scales[i],
